...
// reader, these three methods (POINT_ONLY_METHODS, imported from
// useMercadoPagoPoint — shared with gift card / membership sales) can ONLY
// be charged through it — manual entry for them is removed entirely, not
// offered as an alternative, so staff can never record a fake card payment
// without money actually passing through the reader. Cash/transfer/mp/other
// are unaffected: no card-present equivalent exists for a manual bank
// transfer or cash in hand either way.
